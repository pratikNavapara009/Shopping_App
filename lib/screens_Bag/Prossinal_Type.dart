...
class Proffessional_Type extends StatefulWidget {
  const Proffessional_Type({Key? key}) : super(key: key);

  @override
  State<Proffessional_Type> createState() => _Proffessional_TypeState();
}

class _Proffessional_TypeState extends State<Proffessional_Type> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Aristocratic Proffessional Bag",

...
class Office_Code extends StatefulWidget {
  const Office_Code({Key? key}) : super(key: key);

  @override
  State<Office_Code> createState() => _Office_CodeState();
}

class _Office_CodeState extends State<Office_Code> {
  int i = 0;
